...
class PostListActivity : AppCompatActivity() {
    ...
    private var TAG = "UCShareCar_PostList"
    ...
    override fun onStart() {
        ...
        // When we enter this activity, we will probably have to enter the login activity.
        // TODO how do I save the backend as a private var without defeating the type system?
        // TODO we should not check for login directly. Login should occur iff the BackendClient says so
        val backend = BackendClient.getSingleton(this)
